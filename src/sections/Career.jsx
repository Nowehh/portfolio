    ...
    return (
        <section className="py-28 bg-slate-50 min-h-screen">
            <div className="container mx-auto px-6">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">Career & Education</h2>
                    <p className="text-lg text-slate-500 max-w-2xl mx-auto mb-8">My academic background and qualifications.</p>

                    <a
                        href="/assets/CV_Pro_Noe_Rigoletti.pdf"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-full font-medium hover:bg-blue-700 transition-colors shadow-lg shadow-blue-200"
                    >
                        <Download size={20} />
                        Download Full CV
                    </a>
